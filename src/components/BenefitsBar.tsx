...
const benefits = [
  {
    ...
    glow: "group-hover:shadow-[0_0_30px_hsl(145,80%,45%,0.4)]",
  },
  {
    icon: Shield,
    title: "100% Seguro",
    ...
    glow: "group-hover:shadow-[0_0_30px_hsl(160,80%,45%,0.4)]",
  },
  {
    icon: Star,
    ...
    glow: "group-hover:shadow-[0_0_30px_hsl(160,85%,40%,0.4)]",
  },
  {
    icon: TrendingUp,
    title: "IA Premium",
    ...
    glow: "group-hover:shadow-[0_0_30px_hsl(145,70%,50%,0.4)]",
  },
];

...
const TopBar = () => {
  return (
    <div className="w-full">
      {/* Email Banner - Gradient Orange to Purple */}
      <div className="gradient-mixed py-3 px-4 relative overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute left-10 top-1/2 -translate-y-1/2 w-20 h-20 orb-orange blur-2xl opacity-50" />
        <div className="absolute right-10 top-1/2 -translate-y-1/2 w-20 h-20 orb-purple blur-2xl opacity-50" />
      ...
      {/* WhatsApp Support */}
      <div className="glass-purple py-2.5 px-4 border-b border-purple/20">
